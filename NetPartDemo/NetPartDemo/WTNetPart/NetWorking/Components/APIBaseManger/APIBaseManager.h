...
typedef NS_ENUM (NSUInteger, WTAPIManagerErrorType){
    ...
    WTAPIManagerErrorTypeTimeout,       //请求超时。WTAPIProxy设置的是20秒超时，具体超时时间的设置请自己去看CTAPIProxy的相关代码。
...
typedef void(^WTCompleteBlock)(WTURLResponse *response,WTAPIManagerErrorType error);
