...
{
    static WTAppContext *sharedInstance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[WTAppContext alloc] init];
...
- (CGFloat)latitude
{
    return [WTLocationManager sharedInstance].currentLocation.coordinate.latitude;
}

- (CGFloat)longitude
{
    return [WTLocationManager sharedInstance].currentLocation.coordinate.longitude;
}

- (void)appStarted
{
    self.sessionId = [[NSUUID UUID].UUIDString copy];
    [[WTLocationManager sharedInstance] startLocation];
}

- (void)appEnded
{
    [[WTLocationManager sharedInstance] stopLocation];
}
